...
namespace Dracoon.Sdk.UnitTest.Test.PublicInterfaceImpl {
    public class DracoonServerPoliciesImplTest {
        ...
        public void GetEncryptionPasswordPolicies() {
            ...
            Mock.Arrange(() => c.Executor.DoSyncApiCall<ApiPasswordPolicies>(Arg.IsAny<IRestRequest>(), RequestType.GetPasswordPolicies, 0)).Returns(FactoryPolicies.ApiPasswordSettings).Occurs(1);
