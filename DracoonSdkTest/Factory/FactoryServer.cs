...
namespace Dracoon.Sdk.UnitTest.Factory {
    internal class FactoryServer {
        ...
        internal static ApiServerVersion ApiServerVersionMock {
            get {
                return new ApiServerVersion {
        ...
        internal static ApiServerTime ApiServerTimeMock {
            get {
                return new ApiServerTime {
