...
namespace Dracoon.Sdk.Sort {
    ...
    public class SharesSort : DracoonSort {
        ...
        public static CreatedAtSort<SharesSort> CreatedAt => new CreatedAtSort<SharesSort>(new SharesSort());

        /// <include file = "SpecificSort.xml" path='docs/members[@name="sharesSort"]/ExpireAt/*'/>
        public static ExpireAtSort<SharesSort> ExpireAt => new ExpireAtSort<SharesSort>(new SharesSort());

        /// <include file = "SpecificSort.xml" path='docs/members[@name="sharesSort"]/Name/*'/>
        public static NameSort<SharesSort> Name => new NameSort<SharesSort>(new SharesSort());
    }
}
