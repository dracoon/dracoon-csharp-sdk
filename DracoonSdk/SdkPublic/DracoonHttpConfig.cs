...
namespace Dracoon.Sdk {
    ...
    public class DracoonHttpConfig {
        ...
        public DracoonHttpConfig(bool retryEnabled = false, int readWriteTimeout = 15000, int connectionTimeout = 15000, IWebProxy webProxy = null, string ownUserAgent = null, int chunkSize = 2048) {
