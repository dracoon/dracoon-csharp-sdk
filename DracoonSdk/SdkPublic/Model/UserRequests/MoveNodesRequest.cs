...
namespace Dracoon.Sdk.Model {
    ...
    public class MoveNodesRequest {
        ...
        public List<MoveNode> NodesToBeMoved {
            get; private set;
        }
        ...
        public MoveNodesRequest(long targetNodeId, List<MoveNode> nodesToBeMoved, ResolutionStrategy resolutionStrategy = ResolutionStrategy.AutoRename, bool keepShareLinks = false) {
