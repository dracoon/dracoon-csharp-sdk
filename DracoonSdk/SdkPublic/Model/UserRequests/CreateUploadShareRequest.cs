...
namespace Dracoon.Sdk.Model {
    ...
    public class CreateUploadShareRequest {
        ...
        public CreateUploadShareRequest(long nodeId, string name, bool notifyCreator = false, bool showUploadedFiles = false, string accessPassword = null,
            DateTime? expiration = null, int? uploadedFileExpirationPeriod = null, string notes = null, int? maxAllowedUploads = null, long? maxAllowedTotalSizeOverAllUploadedFiles = null,
            List<string> emailRecipients = null, string emailSubject = null, string emailBody = null, List<string> smsRecipients = null) {
            NodeId = nodeId;
            Name = name;
