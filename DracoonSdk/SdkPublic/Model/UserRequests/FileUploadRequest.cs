...
namespace Dracoon.Sdk.Model {
    ...
    public class FileUploadRequest {
        ...
        public FileUploadRequest(long parentId, string name, Classification? classification = null, ResolutionStrategy resolutionStrategy = ResolutionStrategy.AutoRename, string notes = null, DateTime? expirationDate = null) {
            ParentId = parentId;
            Name = name;
