...
namespace Dracoon.Sdk.Model {
    ...
    public class CopyNodesRequest {
        ...
        public List<CopyNode> NodesToBeCopied {
            get; private set;
        }
        ...
        public CopyNodesRequest(long targetNodeId, List<CopyNode> nodesToBeCopied, ResolutionStrategy resolutionStrategy = ResolutionStrategy.AutoRename, bool keepShareLinks = false) {
